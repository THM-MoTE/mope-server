...
\begin{itemize}
\item \textbf{URL} \code{/mope/connect}
\item \textbf{Method} \code{POST}
\item \textbf{URL Params} Empty
\item \textbf{Data Params}
  The content of the \code{mope-project.json} file. This file is located at the /-directory of the project.
  ...
  \end{lstlisting}
  \decodedAs{de.thm.mope.project.ProjectDescription}
...
\item \textbf{Error Response}
  ...
  \begin{itemize}
  \item The \code{path}-field must be a full path and a directory
