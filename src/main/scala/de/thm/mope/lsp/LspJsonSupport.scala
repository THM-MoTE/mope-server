...
/*  implicit val unitReader = new JsonWriter[Unit] {
  ...
  implicit val documentItemFormat = jsonFormat4(TextDocumentItem)
  ...
  implicit val didOpenNotifyFormat = jsonFormat1(DidOpenTextDocumentParams)
  ...
  implicit val markedStringFormat = jsonFormat2(MarkedString)
